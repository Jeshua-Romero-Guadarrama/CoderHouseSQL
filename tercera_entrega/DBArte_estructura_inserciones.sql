...
-------------------------------------------------------------------------------------------
Archivo: 
- DBArte_estructura_inserciones.sql
Descripción: 
- Script que crea la base de datos "DBArte".
- Script que crea las tablas con sus restricciones.
- Script que inserta datos iniciales.
- Script que crea la vista principal "vw_ArteGeneral".
-------------------------------------------------------------------------------------------
*/
...
*/
DROP DATABASE IF EXISTS DBArte;
...
CREATE TABLE Pais (
    ...
    CONSTRAINT CH_Pais_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]')
...
CREATE TABLE Region (
    ...
    CONSTRAINT FK_Region_Pais 
        ...
        ON UPDATE CASCADE,
    /* Restricción para evitar dígitos en el campo Nombre */
    CONSTRAINT CH_Region_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Ciudad (
    ...
    CONSTRAINT FK_Ciudad_Region 
        ...
        ON UPDATE CASCADE,
    /* Restricción para evitar dígitos en el campo Nombre */
    CONSTRAINT CH_Ciudad_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Direccion (
    ...
    CONSTRAINT CH_Direccion_NumeroSoloDigitos CHECK (Numero REGEXP '^[0-9]+$')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE CategoriaArte (
    CategoriaArteId  INT AUTO_INCREMENT PRIMARY KEY,
    NombreCategoria  VARCHAR(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE SubCategoriaArte (
    SubCategoriaArteId INT AUTO_INCREMENT PRIMARY KEY,
    ...
    CONSTRAINT CH_SubCategoriaArte_NombreNoDigitos CHECK (NombreSubCategoria NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Artista (
    ...
    CONSTRAINT CH_Artista_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]'),
    CONSTRAINT CH_Artista_ApellidoNoDigitos CHECK (Apellido NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE MetodoPago (
    ...
    CONSTRAINT CH_MetodoPago_DescNoDigits CHECK (Descripcion NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

CREATE TABLE MetodoEnvio (
    MetodoEnvioId  INT AUTO_INCREMENT PRIMARY KEY,
    Descripcion    VARCHAR(50) NOT NULL,
    TiempoEstimado VARCHAR(50) NOT NULL,
    /* Ejemplo: 'Courier Internacional', 'Courier Local', 'Recogida en Tienda', etc. */
    CONSTRAINT CH_MetodoEnvio_DescNoDigits CHECK (Descripcion NOT REGEXP '[0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE Cliente (
    ...
    CONSTRAINT CH_Cliente_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]'),
    CONSTRAINT CH_Cliente_ApellidoNoDigitos CHECK (Apellido NOT REGEXP '[0-9]'),
...
CREATE TABLE Vendedor (
    ...
    DireccionId     INT NOT NULL,
    FechaRegistro   INT NOT NULL,
    CONSTRAINT CH_Vendedor_NombreNoDigitos CHECK (Nombre NOT REGEXP '[0-9]'),
    CONSTRAINT CH_Vendedor_ApellidoNoDigitos CHECK (Apellido NOT REGEXP '[0-9]'),
...
/* --------- TABLA: Articulo e Inventario --------- */
INSERT INTO Articulo (CodigoArticulo, Titulo, Descripcion, ArtistaId, SubCategoriaArteId, PrecioBase, AnoCreacion)
...
/*
-------------------------------------------------------------------------------------------
FIN DEL SCRIPT: DBArte_estructura_inserciones.sql
-------------------------------------------------------------------------------------------
*/